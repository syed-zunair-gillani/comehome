...
const Mover = () => {
     ...
     return (
          <>
               <Box component="section" className=' md:grid-cols-2 h-[calc(100vh-179px)] md:!h-screen hidden md:grid'>
                    <Box component="div" className='flex flex-col order-1 justify-center items-center px-10 py-10 pb-0 md:py-0 md:pt-20'>
                         <Box component="div" className='rounded-lg md:lg:py-10 lg:px-10 flex flex-col justify-center  text-[#054DA7]  '>
                              {!openDrive && <Typography variant="h6" onMouseEnter={() => setOpen(true)} className={`text-2xl md:!text-4xl !text-center md:!text-left !font-bold text-[#F18753] font-moranga !mb-8 !leading-[3.2rem]`}> <Box component="span" className="bg-gradient-to-r to-[#F18753] via-[#F18753] from-[#EC2679] px-3 text-white"><FavoriteIcon className='text-white !text-4xl' /> Understand</Box> your customers</Typography>}

                              <Box component="div" className={`h-[62vh] overflow-auto sc ${open ? 'block' : 'hidden'}`} onMouseLeave={() => setOpen(false)}>
                              ...
                              {!open && <Typography variant="h6" onMouseEnter={() => setOpenDrive(true)} className={`text-2xl md:!text-4xl !text-center md:!text-left !font-bold text-[#F18753] font-moranga !mb-8 !leading-[3.2rem]`}> <Box component="span" className="bg-gradient-to-r to-[#F18753] via-[#F18753] from-[#EC2679] px-3 text-white"><GroupIcon className='text-white !text-4xl' /> Drive</Box>  Revenue</Typography>}
                              <Box component="div" className={`h-[62vh] overflow-auto sc ${openDrive ? 'block' : 'hidden'}`} onMouseLeave={() => setOpenDrive(false)}>
                                   <Typography component="p" >A bounce is when a customer visits your webpage and then leaves. It’s a lost lead, a lost booking, a loss to your competitor. <br /><br />
                                        And despite all the years you spent on SEO and money you spent on ads, customers bounce off your website - as high as 90% of the customers on your website never contact you.<br /><br />
                                        And it's no surprise. Filling out 10 fields and then getting robocalled 10 times a day is a lousy experience. It sucks for customers and you know it, but what other choice do you have?  <br /><br />
                                        First impressions are everything, and the estimate and quoting process is their first experience with your team. <br /><br />
                    ...
                    <Box component="div" className='relative group overflow-hidden'>
                         <img src={open ? "/images/child.webp" : openDrive ? '/images/unpack.jpeg' : "/images/child.webp"} alt="image" className='h-full w-full object-cover object-center transition-all duration-300 ease-in-out group-hover:scale-105' />
               ...
               <Box component="section" className='block md:hidden'>
