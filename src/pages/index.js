      ...
      <Box component="section" className='grid md:grid-cols-2 h-[calc(100vh-179px)] md:!h-screen'>
        <Box component="div" className='flex flex-col order-1 justify-center items-center px-10 py-10 md:py-0'>
          <Box component="div" className='max-w-[500px]'>
            <Typography variant="h6" className={`text-2xl md:!text-4xl !text-center md:!text-left !font-bold text-[#F18753] font-moranga !leading-[3.2rem] transition-all duration-200 ease-in-out hover:pl-2`}><Link href="/customer"> <Box component="span" className="bg-gradient-to-r to-[#F18753] via-[#F18753] from-[#EC2679] px-3 text-white">For</Box> Customers</Link></Typography>
            ...
            <Typography variant="h6" className={`text-2xl md:!text-4xl !mt-4 !text-center md:!text-left !font-bold text-[#F18753] font-moranga !leading-[3.2rem] transition-all duration-200 ease-in-out hover:pl-2`}><Link href="/mover"> <Box component="span" className="bg-gradient-to-r to-[#F18753] via-[#F18753] from-[#EC2679] px-3 text-white">For Moving</Box> Companies</Link></Typography>
